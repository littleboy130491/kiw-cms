<!--{{ __('achievements.title') }}-->
<section id="{{ __('achievements.section_id') }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-12 z-10" wire:loading.remove>
        ...
        @empty
            <div class="col-span-full text-center py-12">
                <p class="text-[var(--color-text)] text-lg">{{ __('achievements.no_results') }}</p>
            </div>
        @endforelse
    </div>
