@props([
    ...
    'thumbnailImage' => Storage::url('media/back-video.jpg'),
...
<x-ui.section id="video-home" padding="lg">
    <div class="relative w-full aspect-video rounded-2xl overflow-hidden max-w-6xl mx-auto">
        {{-- Video Thumbnail --}}
        <div class="absolute inset-0 bg-cover bg-center cursor-pointer group"
            style="background-image: url('{{ $thumbnailImage }}')" onclick="loadVideo(this)"
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-8">
                ...
                <div class="mb-6 group-hover:scale-110 transition-transform duration-300">
                    <div
                        class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30">
