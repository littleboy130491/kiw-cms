@props([
    ...
    'isoImages' => [
        asset('storage/media/iso-1.png'),
        asset('storage/media/iso-2.png'),
        asset('storage/media/iso-3.png'),
    ],
    'counters' => [
    ...
    'buttonHref' => '#',
    'images' => [
        ['src' => asset('storage/media/about-home-1.jpg'), 'alt' => 'About KIW 1'],
        ['src' => asset('storage/media/about-home-2.jpg'), 'alt' => 'About KIW 2'],
    ]
])
