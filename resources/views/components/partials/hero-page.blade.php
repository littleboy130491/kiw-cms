<!--Start Hero Page-->
<section id="hero-page" class="relative {{ $imageSize ?? 'bg-cover' }} bg-center overflow-hidden">

    <!-- overlay -->
    <div class="relative {{ $imageSize ?? 'bg-cover' }}" style="background-image:url('{{ $image }}')">
