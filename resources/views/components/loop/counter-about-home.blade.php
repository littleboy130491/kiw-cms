 <!--counter-->
<div class="sm:w-full sm:p-8 p-4 flex flex-col justify-between items-start bg-white rounded-2xl">
    <div class="flex flex-row justify-start gap-1 mb-2">
        ...
        <h3 class="plus gradient-text !font-medium lg:!text-4xl sm:!text-2xl">{{ $suffix ?? '' }}</h3>
    </div>
    <div>
