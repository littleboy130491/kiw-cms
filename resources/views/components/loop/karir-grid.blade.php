...
<!--Item-->
<div
    class="career-loop group transition-all duration-[500ms]  relative flex flex-col bg-[var(--color-transit)] rounded-2xl overflow-hidden">
    ...
    <!--back-->
    <div
        class="back absolute group-hover:top-[0%] top-[100%] transition-all duration-[500ms] flex flex-col justify-end bg-[var(--color-transit)] rounded-2xl gap-3 px-6 pt-6 h-full w-full">
        <div class="flex justify-start items-center gap-2">
            <div class="flex flex-row items-center gap-2">
                <x-icon.calendar-icon-color />
                <p class="!text-[var(--color-purple)] text-[.8em]">
