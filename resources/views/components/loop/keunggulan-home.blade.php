<!--Item-->
<div
    class="keunggulan-item group transition-all duration-[500ms] relative flex flex-col lg:pt-0 sm:pt-6 pt-4 overflow-hidden lg:w-1/6 lg:hover:w-1/3 w-full lg:!min-h-100 !min-h-30 lg:border-r border-b border-[var(--color-bordertransparent)]">
    <!--front-->
    <div
        class="flex flex-col justify-between grow lg:gap-15 gap-5 sm:p-6 sm:pl-0 p-4 pl-0 lg:pl-6 lg:pt-60 pt-0 group-hover:pt-60 transition-[padding] duration-300 ease-in-out">
