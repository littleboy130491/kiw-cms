                ...
                <nav class="hidden lg:flex lg:flex-row lg:justify-end">
                    <ul class="flex flex-row justify-between gap-2 items-end grow">
                        ...
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu menu="beranda" url="/" />
                        </li>

                        <!-- Menu Tentang -->
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu-have-sub menu="Tentang" url="javascript:void(0)" />
                            ...
                            <ul
                                ...
                                <!-- Submenu -->
                                <x-menu.sub-menu menu="Profil Perusahaan" url="/profil-perusahaan" />
                                <x-menu.sub-menu menu="Visi Misi & Tata Nilai" url="/visi-misi-tata-nilai" />
                                <x-menu.sub-menu menu="Manajemen Perusahaan" url="/manajemen-perusahaan" />
                                <x-menu.sub-menu menu="Pedoman & Tata Kelola" url="/pedoman-tata-kelola" />
                                <x-menu.sub-menu menu="Penghargaan & Sertifikasi" url="/penghargaan-sertifikasi" />
                            </ul>
                        </li>
                        ...
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu-have-sub menu="produk & layanan" url="javascript:void(0)" />
                            ...
                            <ul
                                ...
                                <!-- Submenu -->
                                <x-menu.sub-menu menu="Lahan Industri" url="/lahan-industri" />
                                <x-menu.sub-menu menu="Bangunan Pabrik Siap Pakai"
                                    url="/archive-bangunan-pabrik-siap-pakai" />

                                <!-- Submenu have sub menu -->
                                <li class="relative group/submenu">
                                    <x-menu.sub-parent-menu menu="Area Komersil" url="javascript:void(0)" />
                                    ...
                                    <ul
                                        ...
                                        <x-menu.sub-sub-menu menu="ATM" url="/single-area-komersil-atm" />
                                        <x-menu.sub-sub-menu menu="Meeting Room" url="/single-area-komersil" />
                                        <x-menu.sub-sub-menu menu="Sport Center" url="/single-area-komersil" />
                                    </ul>
                                </li>

                                <x-menu.sub-menu menu="Fasilitas" url="/fasilitas" />
                            </ul>
                        </li>
                        ...
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu menu="keunggulan" url="/keunggulan" />
                        </li>

                        <!-- Menu Informasi -->
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu-have-sub menu="Informasi" url="javascript:void(0)" />
                            ...
                            <ul
                                ...
                                <!-- Submenu -->
                                <x-menu.sub-menu menu="Karier" url="/karier" />

                                <!-- Submenu have sub menu -->
                                <li class="relative group/submenu">
                                    <x-menu.sub-parent-menu menu="Pengadaan Barang & Jasa"
                                        url="/pengadaan-barang-jasa" />

                                    <!-- Sub-submenu -->
                                    <ul
                                        class="absolute left-full top-0 mt-0 w-40 bg-white shadow-lg opacity-0 invisible group-hover/submenu:opacity-100 group-hover/submenu:visible transition-all">
                                        <x-menu.sub-sub-menu menu="Tender" url="/archive-tender" />
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu-have-sub menu="Media" url="javascript:void(0)" />
                            ...
                            <ul
                                ...
                                <!-- Submenu -->
                                <x-menu.sub-menu menu="Berita Perusahaan" url="/archive-post" />
                                <x-menu.sub-menu menu="Siaran Pers" url="/archive-post" />
                                <x-menu.sub-menu menu="Berita CSR & Lingkungan" url="/archive-post" />
                                <x-menu.sub-menu menu="Lelang" url="/archive-post-lelang" />
                                <x-menu.sub-menu menu="E-Procurement" url="javascript:void(0)" />
                                <x-menu.sub-menu menu="Whistleblowing System" url="/whistleblowing" />
                                <x-menu.sub-menu menu="Laporan Tahunan" url="/laporan-tahunan" />
                                <x-menu.sub-menu menu="Galeri Dokumentasi" url="/galeri-dokumentasi" />
                            </ul>
                        </li>
                        ...
                        <li class="relative group">
                            <!-- Main Menu -->
                            <x-menu.parent-menu menu="Kontak" url="/kontak" />
                        </li>
                ...
                <div class="px-6 mt-5">
                    ...
                    <div class="pt-10 overflow-y-auto max-h-[95vh] scrollbar-hide">
                        ...
                        <ul class="mt-10 space-y-4">
                            ...
                            <!-- Item -->
                            <x-menu-mobile.parent-menu menu="Beranda" url="/" />
                            ...
                            <x-menu-mobile.parent-menu-have-sub menu="Produk & Layanan" url="javascript:void(0)">
                                ...
                                <x-menu-mobile.menu menu="Bangunan Pabrik Siap Pakai"
                                    url="/archive-bangunan-pabrik-siap-pakai" />
                            ...
                            <!-- Item -->
                            <x-menu-mobile.parent-menu menu="Keunggulan" url="/keunggulan" />

                            <!-- Item w sub -->
                            <x-menu-mobile.parent-menu-have-sub menu="Informasi" url="javascript:void(0)">
                                <x-menu-mobile.menu menu="Karier" url="/karier" />
                                <x-menu-mobile.sub-parent-menu menu="Pengadaan Barang & Jasa"
                                    url="/pengadaan-barang-jasa">
                            ...
                            <!-- Item -->
                            <x-menu-mobile.parent-menu menu="Kontak" url="/kontak" />
                        </ul>
