...
<x-layouts.app>
    ...
    <main>
        ...
        <section id="perjalanan"
            ...
            <div class="sm:max-w-full sm:-top-12 lg:left-1/2 grid grid-cols-2 -mt-14 sm:grid-cols-4 gap-5 lg:w-[1200px] lg:mx-auto">
                ...
                <div class="flex flex-col sm:w-1/2 lg:w-[60%] gap-10">
                    ...
                    <div class="relative">
                        <div class="swiper swiper-3">
                            ...
                            <div class="absolute !top-10 lg:!top-15 swiper-button-next bg-white rounded-[100%] !h-[30px] !w-[30px] p-1 cursor-pointer z-10">
