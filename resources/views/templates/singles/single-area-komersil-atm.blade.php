<x-layouts.app :title="$title ?? 'Default Page'" :body-classes="$bodyClasses">
    ...
    <main>
        ...
        <section id="atm" class="flex flex-col gap-18 lg:gap-20 lg:py-30 py-18 bg-cover">
            ...
            <div class="flex flex-col px-4 sm:px-6 lg:px-0 gap-18 lg:gap-20 lg:w-[1200px] lg:mx-auto">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 lg:gap-4">
                    <x-loop.gallery-grid :image="Storage::url('media/atm1.jpg')" />
                    <x-loop.gallery-grid :image="Storage::url('media/atm2.jpg')" />
                    <x-loop.gallery-grid :image="Storage::url('media/atm3.jpg')" />
                </div>
        ...
        <section id="office-space"
            class="flex flex-col gap-18 lg:gap-20 lg:py-30 py-18 bg-cover bg-[var(--color-transit)]">
