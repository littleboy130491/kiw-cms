...
<x-layouts.app>
    <x-partials.header />
    <main>
        <x-partials.hero-page :image="$item->featuredImage?->url ?? Storage::url('media/visi-misi-hero.jpg')" h1="{!! $item->title ?? 'Visi Misi & Tata Nilai' !!}" />
                                ...
                                @foreach ($visiMisiItems as $item)
                                    ...
                                    <div
                                        ...
                                        <h6 data-aos="fade-down"
                                            class="text-[var(--color-gray)] group-hover:text-white">
                                            {{ $item['data']['title'] }}
                                        </h6>
