...
<x-layouts.app :title="$title ?? 'Default Page'" :body-classes="$bodyClasses">
    ...
    <main>
        <x-header-kiw />
        <x-partials.hero-page image="storage/media/mengapa-kiw-hero.jpg" h1="Mengapa KIW?" />
        ...
        " image="storage/media/perijinan.jpg" id="perijinan" />
        ...
        " image="storage/media/lokasi-strategis.jpg" id="lokasi" />
        ...
        " image="storage/media/berbasis-ekosistem.jpg" id="ekosistem" />
        ...
        " image="storage/media/infrastruktur-fasilitas.jpg" id="infrastruktur" />
        ...
        " image="storage/media/upah-kompetitif.jpg" id="upah" />
        ...
        " image="storage/media/sdm.jpg" id="sdm" />
        ...
        " image="storage/media/ekosistem-klaster.jpg" id="bisnis" />
