<x-layouts.app :title="$title ?? 'Default Page'" :body-classes="$bodyClasses">
    ...
    <main>
        ...
        " image="media/perijinan.jpg" id="perijinan" />
        ...
        " image="media/lokasi-strategis.jpg" id="lokasi" />
        ...
        " image="media/berbasis-ekosistem.jpg" id="ekosistem" />
        ...
        " image="media/infrastruktur-fasilitas.jpg" id="infrastruktur" />
        ...
        " image="media/upah-kompetitif.jpg" id="upah" />
        ...
        " image="media/ekosistem-klaster.jpg" id="bisnis" />
