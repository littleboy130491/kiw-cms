...
<x-layouts.home :title="$title ?? 'Home'" :body-classes="$bodyClasses ?? ''">
    ...
    <x-home.hero-banner :slides="[
        [
            'video' =>
                'https://www.youtube.com/embed/1t_z7FMcsOw?autoplay=1&loop=1&mute=1&controls=0&playlist=1t_z7FMcsOw&modestbranding=1&showinfo=0',
            'fallback_image' => Storage::url('media/background-home.jpg'),
        ...
        [
            'image' => Storage::url('media/hero-home-2.jpg'),
    ...
    {{-- Video Section --}}
    <x-home.video-section videoId="dQw4w9WgXcQ" :thumbnailImage="Storage::url('media/back-video.jpg')" title="Kawasan Industri Wijayakusuma"
