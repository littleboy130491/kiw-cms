    ...
    <main>
        ...
        <section id="bangunan-pabrik"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <x-loop.bpsp tag="tersedia" label="BPSB 1" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="segera hadir" label="BPSP 2" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="tersewa sampai 2025" label="BPSP 3" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="segera hadir" label="BPSP 4" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="segera hadir" label="BPSP 5" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="segera hadir" label="BPSP 6" image="storage/media/bpsp.jpg" url="#" />

                <x-loop.bpsp tag="segera hadir" label="BPSP 7" image="storage/media/bpsp.jpg" url="#" />
